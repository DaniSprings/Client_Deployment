...
return (
     <> 
            ...
            <ul className='Definitions'>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Rev-review.</p>
                </li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Rev-review, accessible from <a href="www.revreview.co.za" rel="external nofollow noopener" target="_blank">www.revreview.co.za</a>.</p>
                </li>
                <li>
            ...
            <ul>
            <li>By email: info@revreview.co.za</li>
            </ul>
     </> 
    );
}
