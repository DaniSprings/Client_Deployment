...
function CarStats() {
    ...
    const toggleMoreInfo = (carId) => {
        setExpandedDetails(prev => ({ ...prev, [carId]: !prev[carId] }));
    };
    ...
    return (
        <div className="carstat-main-container">
            ...
            <p>Please see your selection of vehicles you want to compared</p>
                            ...
                            <div key={carId} className="car-detail-card">
                                ...
                                {(details.towingBraked || details.towingUnbraked || details.kerbWeight || details.gvm || details.dryWeight) && (
                                    <div className="detail-section">
                                        ...
                                        <p><strong>Water Depth:</strong> {formatDetailValue(details.wadingDepth, ' mm')}</p>
                                    </div>
                                )}
                                ...
                                <div className="detail-section more-info-toggle">
                                    <button
                                        ...
                                        onClick={() => toggleMoreInfo(carId)}
                                    >
                                        {expandedDetails[carId] ? 'Hide Full Specs ▲' : 'More Info ▼'}
                                    </button>
                                </div>
                                ...
                                {expandedDetails[carId] && (
                                    <>
                                        ...
                                        <div className="detail-section">
                                            <h4>Additional Features & Comfort</h4>
